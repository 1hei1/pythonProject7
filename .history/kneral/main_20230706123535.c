...
void init_kneral(){
    ...
    init_task_point();
    char ID = creat_task("task1");
    char ID2 = creat_task("task2");
    delete_task(ID);
    char ID3 = creat_task("task3");
    char ID4 = creat_task("task4");
    char ID5 = creat_task("task5");
    char ID6 = creat_task("task6");
    char ID7 = creat_task("task7");
    char ID8 = creat_task("task8");
    delete_task(ID);
    char ID9 = creat_task("task9");
    while (1)
    {
        /* code */
    }
