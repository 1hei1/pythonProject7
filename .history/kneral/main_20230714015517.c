...
void init_kneral(){
    ...
    init_task_point();
    char ID = creat_task("task1",&taskn,10);
    char ID2 = creat_task("task2",&taskm,9);
    char ID3 = creat_task("task2",&taskq,8);
    char ID4 = creat_task("task2",&taskpp,7);
    char ID5 = creat_task("task2",&taskb,6);
