...
void init_kneral(){
    ...
    init_task_point();
    char ID = creat_task("task1",&taskn,10,100);
    char ID2 = creat_task("task2",&taskm,9,200);
    char ID3 = creat_task("task2",&taskq,8,300);
    char ID4 = creat_task("task2",&taskpp,7,500);
    char ID5 = creat_task("task2",&taskb,6,800);
