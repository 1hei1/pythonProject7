...
void schedule()
{
    ...
    //     //print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
        ...
        task_ready_header.next_task = next_task->next_task;
        // second = task_ready_ender.fond_task;
        // second->next_task = next_task;
        // next_task->next_task = &task_ready_ender;
        // next_task->fond_task = second;
        // task_ready_ender.fond_task = next_task;
        // task_run_header.next_task = next_task;
        tasks_order();
