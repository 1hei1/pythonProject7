...
struct idt_point idt_point;//gdtr指针
...
void init_control(){
    ...
    outb(main_control_h,0b11111111);//屏蔽任何中断xxxxxxxxxxxxxxxxx
    //初始化片控制器
    ...
    outb(slice_control_h,0b11111111);//屏蔽任何中断xxxxxxxxxxxxxxxxxxx
...
void init_idt(){
    ...
    set_handles(0x20,&task1);
    set_handles(0x21,&task2);
}
