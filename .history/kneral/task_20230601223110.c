...
char task_tables(){
    ...
    char max_privilege = tasks.tasks[last_index].privilege;
    char max_ID = tasks.tasks[last_index].ID;
    int max_address = tasks.tasks[last_index].address;
    ...
    if(tasks.tasks[last_index].privilege==0){
        tasks.tasks[last_index].privilege = 3;
    }
    tasks.tasks[last_index].privilege--;
